...
simulation_time = 25.0 # you are allowed to change this
...
class MyRobot:
    ...
    def close(self):
       self.Jcontrol= PIJoint(self.target_positions, self.dt, self.Kp, self.Ki)
       v = self.Jcontrol.update(self.robot.positions()[1])
    ...
    # def on_enter_J(self):
    #    self.tf2.set_translation([box_positions[green_box_pt][0], box_positions[green_box_pt][1], self.tf2.translation()[2] ])
    #    self.controller = PITask(self.tf2, self.dt, self.Kp, self.Ki) 
